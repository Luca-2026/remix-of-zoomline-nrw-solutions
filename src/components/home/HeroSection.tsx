  ...
  return (
    <section className="relative overflow-hidden min-h-[600px] lg:min-h-[700px]">
      <div className="absolute inset-0">
        <img 
          src={heroGrafik} 
          alt="Arbeitsbühne kaufen NRW - Scherenarbeitsbühnen, Teleskopbühnen und Gelenkbühnen von Zoomlion" 
        ...
        <div className="max-w-2xl">
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 rounded-full bg-primary/20 backdrop-blur-sm px-4 py-1.5 text-sm font-medium text-primary mb-6 animate-fade-in-down opacity-0" style={{ animationDelay: '0.1s' }}>
              ...
              Exklusiver Zoomlion Fachhändler in NRW
            </div>
            ...
            <p className="mt-6 text-lg md:text-xl text-white/90 max-w-xl mx-auto lg:mx-0 animate-fade-in-up opacity-0" style={{ animationDelay: '0.3s' }}>
              Scherenarbeitsbühnen, Teleskopbühnen & Gelenkbühnen vom Top 5 Hersteller weltweit. 
              3 Standorte in NRW – mit 3 Jahren Garantie und Ersatzteilen vor Ort.
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up opacity-0" style={{ animationDelay: '0.4s' }}>
              <Button asChild size="lg" className="group hover-glow transition-all duration-300">
                <Link to="/arbeitsbuehne-kaufen-nrw" className="flex items-center">
                  <img src={iconArbeitsbuehne} alt="Arbeitsbühne kaufen" className="mr-3 h-8 w-8 object-contain" />
                  Jetzt konfigurieren
                  <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                </Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="border-white/30 bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 hover:text-white transition-all duration-300 group">
                <Link to="/arbeitsbuehne-sonderangebote-nrw" className="flex items-center">
